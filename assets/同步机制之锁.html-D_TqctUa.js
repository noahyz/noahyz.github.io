...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后封装好加锁和解锁函数。临界区是关中断的。</p>`,24),p=[l];function t(d,r){return a(),n("div",null,p)}const u=s(i,[["render",t],["__file","同步机制之锁.html.vue"]]),m=JSON.parse('{"path":"/%E6%8A%80%E6%9C%AF%E4%B8%93%E9%A2%98/%E6%89%8B%E5%86%99%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/9.%E5%85%B6%E4%BB%96/%E5%90%8C%E6%AD%A5%E6%9C%BA%E5%88%B6%E4%B9%8B%E9%94%81.html","title":"同步机制---锁","lang":"zh-CN","frontmatter":{"title":"同步机制---锁","description":"我们的锁使用 信号量来实现。信号量包括两个操作 增加操作：将信号量的值加 1，唤醒在此信号量上等待的线程 减少操作：判断信号量是否大于 0。若信号量大于 0，则将信号量减一；若信号量等于 0，当前线程将自己阻塞，以在此信号量上等待 线程的阻塞是线程自己发出的动作，也就是线程自己阻塞自己，并不是被别人阻塞的，阻塞是线程主动的行为。已阻塞的线程是由别人来唤...","head":[["meta",{"property":"og:url","content":"https://javabetter.cn/%E6%8A%80%E6%9C%AF%E4%B8%93%E9%A2%98/%E6%89%8B%E5%86%99%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/9.%E5%85%B6%E4%BB%96/%E5%90%8C%E6%AD%A5%E6%9C%BA%E5%88%B6%E4%B9%8B%E9%94%81.html"}],["meta",{"property":"og:site_name","content":"张意的博客"}],["meta",{"property":"og:title","content":"同步机制---锁"}],["meta",{"property":"og:description","content":"我们的锁使用 信号量来实现。信号量包括两个操作 增加操作：将信号量的值加 1，唤醒在此信号量上等待的线程 减少操作：判断信号量是否大于 0。若信号量大于 0，则将信号量减一；若信号量等于 0，当前线程将自己阻塞，以在此信号量上等待 线程的阻塞是线程自己发出的动作，也就是线程自己阻塞自己，并不是被别人阻塞的，阻塞是线程主动的行为。已阻塞的线程是由别人来唤..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"张意"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"同步机制---锁\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"张意\\",\\"url\\":\\"/about-the-author/\\"}]}"]]},"headers":[{"level":3,"title":"一、线程阻塞","slug":"一、线程阻塞","link":"#一、线程阻塞","children":[]},{"level":3,"title":"二、锁的实现","slug":"二、锁的实现","link":"#二、锁的实现","children":[]}],"git":{},"readingTime":{"minutes":5,"words":1499},"filePathRelative":"技术专题/手写操作系统/9.其他/同步机制之锁.md","excerpt":"<p>我们的锁使用 信号量来实现。信号量包括两个操作</p>\\n<ul>\\n<li>增加操作：将信号量的值加 1，唤醒在此信号量上等待的线程</li>\\n<li>减少操作：判断信号量是否大于 0。若信号量大于 0，则将信号量减一；若信号量等于 0，当前线程将自己阻塞，以在此信号量上等待</li>\\n</ul>\\n<p>线程的阻塞是线程自己发出的动作，也就是线程自己阻塞自己，并不是被别人阻塞的，阻塞是线程主动的行为。已阻塞的线程是由别人来唤醒的，唤醒是被动的。</p>\\n<p>注意，线程阻塞时，线程的时间片还没用完，在唤醒之后，线程会继续在剩余时间片内运行，调度器不会为他充满时间片。</p>\\n<h3>一、线程阻塞</h3>","autoDesc":true}');export{u as comp,m as data};
